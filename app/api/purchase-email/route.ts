...
export async function POST(request: NextRequest) {
  ...
  */
  ...
  const mailOptions: Mail.Options = {
    ...
    text: `Email: ${email} | Fullname: ${fullName} | Shipping Address: ${shippingAddress} | Special Instructions: ${specialInstructions} | Product Name: ${productName} | Product Price: $${productPrice}`,
    html:`
